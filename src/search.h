...
#define MAEP_SEARCH_CONTEXT(obj)                                                                   \
  (G_TYPE_CHECK_INSTANCE_CAST(obj, MAEP_TYPE_SEARCH_CONTEXT, MaepSearchContext))
#define MAEP_SEARCH_CONTEXT_CLASS(klass)                                                           \
  (G_TYPE_CHECK_CLASS_CAST(klass, MAEP_TYPE_SEARCH_CONTEXT, MaepSearchContextClass))
#define MAEP_IS_SEARCH_CONTEXT(obj) (G_TYPE_CHECK_INSTANCE_TYPE(obj, MAEP_TYPE_SEARCH_CONTEXT))
#define MAEP_IS_SEARCH_CONTEXT_CLASS(klass)                                                        \
  (G_TYPE_CHECK_CLASS_TYPE(klass, MAEP_TYPE_SEARCH_CONTEXT))
#define MAEP_SEARCH_CONTEXT_GET_CLASS(obj)                                                         \
  (G_TYPE_INSTANCE_GET_CLASS(obj, MAEP_TYPE_SEARCH_CONTEXT, MaepSearchContextClass))
